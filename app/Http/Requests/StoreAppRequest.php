...
class StoreAppRequest extends FormRequest
{
    ...
    /**
     * Fill the slug from the name when the admin left it blank, and normalise
     * the checkbox into a real boolean.
     */
    ...
    public function rules(): array
    {
        return [
            ...
            'package_id' => [
                ...
                // Android application id: dot-separated segments, each starting
                // with a letter. e.g. com.ziroone.crm
